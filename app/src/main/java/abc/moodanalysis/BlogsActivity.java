...
public class BlogsActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mrecycle=(RecyclerView)findViewById(R.id.blogslist);
...
//        mdbreferencelikes.keepSynced(true);
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<blog,blogViewHolder> adapter=new FirebaseRecyclerAdapter<blog, blogViewHolder>(
            ...
            protected void populateViewHolder(blogViewHolder viewHolder, blog model, int position) {
                ...
                final String y=model.getDescription();
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_camera) {
            ...
            startActivity(new Intent(BlogsActivity.this,PostEventsActivity.class));
